...
| `agent.md` | The agent contract | the agent contract an adapter implements: the call, the envelope, the exit table, the types, the six verbs and what they mean, `fleet agent schema` | drafted |
